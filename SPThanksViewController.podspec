#
# Be sure to run `pod spec lint SPThanksViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "tnantoka" => "bornneet@livedoor.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'tnantoka', 'other author'
